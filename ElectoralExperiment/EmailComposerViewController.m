...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    [UserDemographicSpreadsheetGenerator generateUserDemographicSpreadsheetDataSets];
...
-(void)displayComposerSheet 
{
    ...
    NSArray *fileNamesArray = [NSArray arrayWithObjects:
                               ...
                               kUserDemographicSpreadsheetDataSetFilename,
    ...
    NSString *emailBody = @"Below are the data files that were generated by the MVC voting experiment.";
